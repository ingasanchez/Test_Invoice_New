...
namespace CustomerInvoice.Web.Controllers
{
    public class CustomerTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Description")] CustomerType customerType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description")] CustomerType customerType)
        {
            if (ModelState.IsValid)
            {
